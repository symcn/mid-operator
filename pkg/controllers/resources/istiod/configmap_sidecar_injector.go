...
func (r *Reconciler) configMapInjector() runtime.Object {
	labels := utils.MergeStringMaps(sidecarInjectorLabels, labelSelector)
	...
	values := map[string]interface{}{
		...
		"global": map[string]interface{}{
			"mtls": map[string]interface{}{
				"auto": utils.PointerToBool(r.Config.Spec.AutoMTLS),
			},
			"istiod": map[string]interface{}{
				"enabled": utils.PointerToBool(r.Config.Spec.Istiod.Enabled),
			},
			...
			"proxy_init": map[string]interface{}{
				"cniEnabled":    utils.PointerToBool(r.Config.Spec.SidecarInjector.InitCNIConfiguration.Enabled),
...
func (r *Reconciler) siConfig() string {
	...
	if utils.PointerToBool(r.Config.Spec.SidecarInjector.AutoInjectionPolicyEnabled) {
...
func (r *Reconciler) coreDumpContainer() string {
	if !utils.PointerToBool(r.Config.Spec.Proxy.EnableCoreDump) {
		return ""
	}

	coreDumpContainerYAML, err := yaml.Marshal([]corev1.Container{
...
func (r *Reconciler) getFormattedResources(resources *corev1.ResourceRequirements, indentSize int) string {
